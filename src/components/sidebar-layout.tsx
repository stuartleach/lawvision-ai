...
export function SidebarLayout({
  ...
  return (
    <div className="relative isolate flex min-h-screen w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      {/* Content */}
      <main className="flex flex-1 flex-col lg:pl-64 lg:pr-2 lg:pt-2">
        <div className="flex-grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
