        ...
        <div className="space-y-4 mb-4">
            ...
            <div>
                ...
                <div className="flex justify-between mt-1">
                    <span className="text-sm text-gray-500">{formatNumber(minCases)}</span>
                    <span className="text-sm text-gray-500">{formatNumber(maxCases)}</span>
                </div>
            </div>
            <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="compareToStateAverage" className="text-sm text-gray-300">
                ...
                <input
                    ...
                    className="form-checkbox h-5 w-5 text-blue-600"
                />
                <label htmlFor="compareToCountyAverage" className="text-sm text-gray-300">
