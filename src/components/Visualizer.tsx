...
const Visualizer: React.FC<VisualizerProps> = ({ data, type }) => {
    ...
    const drawBarChart = () => {
        ...
        const severityLevels: SeverityLevel[] = ["Any", "AF", "BF", "CF", "DF", "EF", "I", "V", "AM", "BM", "UM"];
    ...
    const drawPieChart = () => {
        ...
        const label = d3.arc<d3.PieArcDatum<any>>()
            .outerRadius(radius)
            .innerRadius(radius - 80);

        const pieData = [
            { name: "Bail Set", value: data.arraignmentResults.Any.Any.bailSet.percent },
            { name: "Remanded", value: data.arraignmentResults.Any.Any.remanded.percent },
            { name: "Released", value: data.arraignmentResults.Any.Any.released.percent }
        ];
    ...
    const drawLineChart = () => {
        ...
        const line = d3.line<{ severity: string, avgBail: number }>()
            .x(d => x(d.severity) || 0)
            .y(d => y(d.avgBail));
